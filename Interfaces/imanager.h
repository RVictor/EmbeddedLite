 ...
 * You should use this class to interact with EmbeddedLite
 */
class IManager
{
public:
	...
	/**
	 * @brief return the startup directory of EmbeddedLite which is also the base directory for searching installation files
  ...
  /**
	 * @brief return the configuration directory of plugins.
	 * @return a full path to plugins configuration directory.
	 */
	...
	/**
	 * @brief return an instance to the tags manager - which allows access to EmbeddedLite CodeCompletion API
