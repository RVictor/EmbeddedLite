...
protected:
	...
	CmpCmdLineOptions m_assemblerOptions;
...
public:
	...
	const CmpCmdLineOptions& GetAssemblerOptions() const {
		return m_assemblerOptions;
	}
	
	void SetAssemblerOptions(const CmpCmdLineOptions& cmpOptions) {
		m_assemblerOptions = cmpOptions;
	}
