...
//rvv	const wxString ALL(wxT("EmbeddedLite Workspace files (*.workspace)|*.workspace|")
//rvv	                   wxT("All Files (*)|*"));
	wxString ALL = wxString::Format(wxT("EmbeddedLite Workspace files (*.%s)|*.%s|"), EL_WORKSPACE_EXT, EL_WORKSPACE_EXT) + 
	                   wxT("All Files (*)|*");
