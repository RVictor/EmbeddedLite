...
ProjectConfigurationBasePanel::ProjectConfigurationBasePanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_stTxtBuildDir = new wxStaticText( m_generalPage, wxID_ANY, wxT("Build Directory:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stTxtBuildDir->Wrap( -1 );
	fgSizer3->Add( m_stTxtBuildDir, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_txtBuildDirectory = new wxTextCtrl( m_generalPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_txtBuildDirectory, 0, wxALL|wxEXPAND, 5 );
	
	m_btnBrowseBuildDir = new wxButton( m_generalPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_btnBrowseBuildDir, 0, wxALL, 5 );
	...
	m_AssemblerPage = new wxPanel( m_notebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* compilerPageSizer1;
	compilerPageSizer1 = new wxBoxSizer( wxVERTICAL );
	
	m_pCntlChkAssemblerNeeded = new wxCheckBox( m_AssemblerPage, wxID_ANY, wxT("Assembler is not required for this project"), wxDefaultPosition, wxDefaultSize, 0 );
	compilerPageSizer1->Add( m_pCntlChkAssemblerNeeded, 0, wxALL, 5 );
	
	wxBoxSizer* bSizer230011;
	bSizer230011 = new wxBoxSizer( wxHORIZONTAL );
	
	m_staticText3312 = new wxStaticText( m_AssemblerPage, wxID_ANY, wxT("Use with global settings :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText3312->Wrap( -1 );
	bSizer230011->Add( m_staticText3312, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	wxArrayString m_choiceAsmUseWithGlobalSettingsChoices;
	m_choiceAsmUseWithGlobalSettings = new wxChoice( m_AssemblerPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceAsmUseWithGlobalSettingsChoices, 0 );
	m_choiceAsmUseWithGlobalSettings->SetSelection( 0 );
	bSizer230011->Add( m_choiceAsmUseWithGlobalSettings, 1, wxALL, 5 );
	
	compilerPageSizer1->Add( bSizer230011, 0, wxEXPAND, 5 );
	
	m_staticline71 = new wxStaticLine( m_AssemblerPage, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	compilerPageSizer1->Add( m_staticline71, 0, wxEXPAND | wxALL, 5 );
	
	wxFlexGridSizer* fgSizer81;
	fgSizer81 = new wxFlexGridSizer( 3, 3, 0, 0 );
	...
	m_staticText61 = new wxStaticText( m_AssemblerPage, wxID_ANY, wxT("Assembler Options:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText61->Wrap( -1 );
	fgSizer81->Add( m_staticText61, 0, wxALL, 5 );
	
	m_textAssemblerOptions = new wxTextCtrl( m_AssemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_textAssemblerOptions, 0, wxALL|wxEXPAND, 5 );
	
	m_buttonAssemblerOptions = new wxButton( m_AssemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_buttonAssemblerOptions, 0, wxALL, 5 );
	
	m_staticText41 = new wxStaticText( m_AssemblerPage, wxID_ANY, wxT("Additional Search Path:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText41->Wrap( -1 );
	fgSizer81->Add( m_staticText41, 0, wxALL, 5 );
	
	m_txtAsmAdditionalSearchPath = new wxTextCtrl( m_AssemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_txtAsmAdditionalSearchPath, 0, wxALL|wxEXPAND, 5 );
	
	m_pCntlBtnAsmAddSearchPath = new wxButton( m_AssemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_pCntlBtnAsmAddSearchPath, 0, wxALL, 5 );
	
	m_staticText1711 = new wxStaticText( m_AssemblerPage, wxID_ANY, wxT("Preprocessor:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1711->Wrap( -1 );
	fgSizer81->Add( m_staticText1711, 0, wxALL, 5 );
	
	m_txtAsmPreprocessor = new wxTextCtrl( m_AssemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_txtAsmPreprocessor, 0, wxALL|wxEXPAND, 5 );
	
	m_btnAsmPreprocessor = new wxButton( m_AssemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer81->Add( m_btnAsmPreprocessor, 0, wxALL, 5 );
	
	compilerPageSizer1->Add( fgSizer81, 0, wxEXPAND, 5 );
	
	wxBoxSizer* bSizer321;
	bSizer321 = new wxBoxSizer( wxVERTICAL );
	
	compilerPageSizer1->Add( bSizer321, 0, wxEXPAND, 5 );
	
	m_AssemblerPage->SetSizer( compilerPageSizer1 );
	m_AssemblerPage->Layout();
	compilerPageSizer1->Fit( m_AssemblerPage );
	m_notebook->AddPage( m_AssemblerPage, wxT("Assembler"), true );
	...
	m_txtBuildDirectory->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnBrowseBuildDir->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnBrowseBuildDir ), NULL, this );
	...
	m_pCntlChkAssemblerNeeded->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCheckAssemblerNeeded ), NULL, this );
	m_textAssemblerOptions->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_buttonAssemblerOptions->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnButtonAddAssemblerOptions ), NULL, this );
	m_txtAsmAdditionalSearchPath->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_pCntlBtnAsmAddSearchPath->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnAddAsmSearchPath ), NULL, this );
	m_txtAsmPreprocessor->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAsmPreprocessor->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnBtnAddAsmPreprocessor ), NULL, this );
...
ProjectConfigurationBasePanel::~ProjectConfigurationBasePanel()
{
	...
	m_txtBuildDirectory->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnBrowseBuildDir->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnBrowseBuildDir ), NULL, this );
	...
	m_pCntlChkAssemblerNeeded->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCheckAssemblerNeeded ), NULL, this );
	m_textAssemblerOptions->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_buttonAssemblerOptions->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnButtonAddAssemblerOptions ), NULL, this );
	m_txtAsmAdditionalSearchPath->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_pCntlBtnAsmAddSearchPath->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnAddAsmSearchPath ), NULL, this );
	m_txtAsmPreprocessor->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAsmPreprocessor->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ProjectConfigurationBasePanel::OnBtnAddAsmPreprocessor ), NULL, this );
...
GlobalSettingsBasePanel::GlobalSettingsBasePanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_staticText61 = new wxStaticText( m_assemblerPage, wxID_ANY, wxT("Assembler Options:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText61->Wrap( -1 );
	fgSizer101->Add( m_staticText61, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_textAssemblerOptions = new wxTextCtrl( m_assemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_textAssemblerOptions, 0, wxALL|wxEXPAND, 5 );
	
	m_btnAsmOptions = new wxButton( m_assemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_btnAsmOptions, 0, wxALL, 5 );
	
	m_staticText41 = new wxStaticText( m_assemblerPage, wxID_ANY, wxT("Additional Search Path:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText41->Wrap( -1 );
	fgSizer101->Add( m_staticText41, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_txtAsmAdditionalSearchPath = new wxTextCtrl( m_assemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_txtAsmAdditionalSearchPath, 0, wxALL|wxEXPAND, 5 );
	
	m_pCntlAsmAdditionalSearchPath = new wxButton( m_assemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_pCntlAsmAdditionalSearchPath, 0, wxALL, 5 );
	
	m_staticText1711 = new wxStaticText( m_assemblerPage, wxID_ANY, wxT("Preprocessor:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1711->Wrap( -1 );
	fgSizer101->Add( m_staticText1711, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_txtAsmPreprocessor = new wxTextCtrl( m_assemblerPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_txtAsmPreprocessor, 0, wxALL|wxEXPAND, 5 );
	
	m_btnAddAsmPreprocessor = new wxButton( m_assemblerPage, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer101->Add( m_btnAddAsmPreprocessor, 0, wxALL, 5 );
	
	compilerPageSizer1->Add( fgSizer101, 0, wxEXPAND, 5 );
	...
	m_textAssemblerOptions->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAsmOptions->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnButtonAddAssemblerOptions ), NULL, this );
	m_txtAsmAdditionalSearchPath->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_pCntlAsmAdditionalSearchPath->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnAsmAdditionalSearchPath ), NULL, this );
	m_txtAsmPreprocessor->Connect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAddAsmPreprocessor->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnBtnAddAsmPreprocessor ), NULL, this );
...
GlobalSettingsBasePanel::~GlobalSettingsBasePanel()
{
	...
	m_textAssemblerOptions->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAsmOptions->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnButtonAddAssemblerOptions ), NULL, this );
	m_txtAsmAdditionalSearchPath->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_pCntlAsmAdditionalSearchPath->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnAsmAdditionalSearchPath ), NULL, this );
	m_txtAsmPreprocessor->Disconnect( wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler( GlobalSettingsBasePanel::OnCmdEvtVModified ), NULL, this );
	m_btnAddAsmPreprocessor->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( GlobalSettingsBasePanel::OnBtnAddAsmPreprocessor ), NULL, this );
