...
AboutDlgBase::AboutDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer3->SetMinSize( wxSize( 449,313 ) ); 
	m_bitmap = new wxStaticBitmap( m_panel1, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, 0 );
	m_bitmap->SetMinSize( wxSize( 449,313 ) );
	m_bitmap->SetMaxSize( wxSize( 449,313 ) );
	...
	m_hyperlink1 = new wxHyperlinkCtrl( this, wxID_ANY, wxT("http://www.embeddedlite.rvictor.de"), wxT("http://www.embeddedlite.rvictor.de"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
