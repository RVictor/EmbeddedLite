...
class ProjectConfigurationBasePanel : public wxPanel 
{
	...
	protected:
		...
		wxStaticText* m_stTxtBuildDir;
		wxTextCtrl* m_txtBuildDirectory;
		wxButton* m_btnBrowseBuildDir;
		...
		wxPanel* m_AssemblerPage;
		wxCheckBox* m_pCntlChkAssemblerNeeded;
		wxStaticText* m_staticText3312;
		wxChoice* m_choiceAsmUseWithGlobalSettings;
		wxStaticLine* m_staticline71;
		wxStaticText* m_staticText61;
		wxTextCtrl* m_textAssemblerOptions;
		wxButton* m_buttonAssemblerOptions;
		wxStaticText* m_staticText41;
		wxTextCtrl* m_txtAsmAdditionalSearchPath;
		wxButton* m_pCntlBtnAsmAddSearchPath;
		wxStaticText* m_staticText1711;
		wxTextCtrl* m_txtAsmPreprocessor;
		wxButton* m_btnAsmPreprocessor;
		...
		virtual void OnBrowseBuildDir( wxCommandEvent& event ) { event.Skip(); }
		...
		virtual void OnCheckAssemblerNeeded( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonAddAssemblerOptions( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAddAsmSearchPath( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnBtnAddAsmPreprocessor( wxCommandEvent& event ) { event.Skip(); }
...
class GlobalSettingsBasePanel : public wxPanel 
{
	...
	protected:
		...
		wxStaticText* m_staticText61;
		wxTextCtrl* m_textAssemblerOptions;
		wxButton* m_btnAsmOptions;
		wxStaticText* m_staticText41;
		wxTextCtrl* m_txtAsmAdditionalSearchPath;
		wxButton* m_pCntlAsmAdditionalSearchPath;
		wxStaticText* m_staticText1711;
		wxTextCtrl* m_txtAsmPreprocessor;
		wxButton* m_btnAddAsmPreprocessor;
		wxPanel* m_linkerPage;
		wxStaticText* m_staticText10;
		wxTextCtrl* m_textLinkerOptions;
		wxButton* m_buttonLinkerOptions;
		...
		virtual void OnButtonAddPreprocessor( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonAddAssemblerOptions( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAsmAdditionalSearchPath( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnBtnAddAsmPreprocessor( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnButtonAddLinkerOptions( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAddLibraryPath( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnAddLibrary( wxCommandEvent& event ) { event.Skip(); }
