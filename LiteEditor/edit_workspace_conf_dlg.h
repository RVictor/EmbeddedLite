...
public:
	EditWorkspaceConfDlg( wxWindow* parent, int id = wxID_ANY, wxString title = wxT("Edit Solution Configuration"), wxPoint pos = wxDefaultPosition, wxSize size = wxSize( 362,261 ), int style = wxDEFAULT_DIALOG_STYLE );
