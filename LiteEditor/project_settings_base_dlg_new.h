...
class ProjectConfigurationBasePanel : public wxPanel 
{
	...
	protected:
		...
		wxStaticText* m_pCntlStAsmText331;
		wxChoice*     m_choiceAsmUseWithGlobalSettings;
		wxStaticLine* m_asmStCntl7;
		wxStaticText* m_pCntlStAsml6;
		wxTextCtrl*   m_textAssemblerOptions;
		wxButton*     m_buttonAssemblerOptions;
		wxStaticText* m_pCntlAsmTxt4;
		wxTextCtrl*   m_pCntlTxtAdditionalSearchPath;
