...
extern "C" EXPORT PluginInfo GetPluginInfo()
{
	...
	info.SetDescription(wxT("A plugin that allows user to launch external tools from within EmbeddedLite"));
...
ExternalToolsPlugin::ExternalToolsPlugin(IManager *manager)
		...
		, m_parentMenu  (NULL)
{
	m_longName = wxT("A plugin that allows user to launch external tools from within EmbeddedLite");
