/**
  \file copyrights_options_base_dlg.cpp              
...
CopyrightsOptionsBaseDlg::CopyrightsOptionsBaseDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_textCtrlIgnoreString->SetToolTip( wxT("Set here a string that once found in the source file EmbeddedLite will not prepend the Copyrights block to the file") );
