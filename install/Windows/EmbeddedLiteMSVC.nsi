...
; The file to write
OutFile "EmbeddedLiteMSVCSetup.exe"
...
Section "EmbeddedLite (required)"
  ...
  ; Put file there
  File "..\..\build\Release\EmbeddedLite.exe"
  File "..\..\build\Release\*.dll"
  ; Copy the misc files
  File "..\..\build\Release\emblite_indexer.exe"
;  File "..\..\build\Release\emblite_cppcheck.exe"
;  File "..\..\build\Release\emblite_launcher.exe"
;  File "..\..\build\Release\makedir.exe"
;  File "..\..\build\Release\le_exec.exe"
;  File "..\..\build\Release\patch.exe"
  File "..\distr\astyle.sample"
;  File "..\..\build\Release\*.template"
  File "..\distr\*.html"
  File "license.txt"
  ...
  File "..\..\build\Release\debuggers\*.dll"
  ...
  File /r "..\..\build\Release\plugins\*.dll"
