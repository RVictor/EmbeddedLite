...
typedef WINBASEAPI BOOL WINAPI TFn_DBG_BREAK_PROC(HANDLE);
typedef TFn_DBG_BREAK_PROC* TPFn_DBG_BREAK_PROC;
  TPFn_DBG_BREAK_PROC DebugBreakProcessFunc = NULL;
		...
		, m_cliHandler (NULL)
{
	...
	if (Kernel32Dll) {
		DebugBreakProcessFunc = (TPFn_DBG_BREAK_PROC)GetProcAddress(Kernel32Dll, "DebugBreakProcess");
	} else {
